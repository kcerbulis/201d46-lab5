...
first element is the sum of those numbers, and the second element is a concatenated string that
...
the second element is the product of those three numbers,  and the third and fourth elements
...
the first element is the sum of the numbers in the array, and the second element is a string that EXACTLY follows this example
...
function that you've already created. You're going to have to be resourceful to figure out how to do this. However, you may continue to
...
function sumArray(sumArr) { //eslint-disable-line
    var firstArraySum = sum(sumArr[0], sumArr[1])[0];
    // console.log(firstArraySum);
    var totalArraySum = sum(firstArraySum, sumArr[2])[0];
    // console.log(totalArraySum);
    return [totalArraySum, sumArr[0] + ',' + sumArr[1] + ',' + sumArr[2] + ' was passed in as an array of numbers, and ' + totalArraySum + ' is their sum.']
}
...
IMPORTANT DETAIL: You may not use the arithmetic operator * in this function. To do multiplication,
 ...
 to figure out how to do this. This function should handle an array containing three elements.
...
function multiplyArray(multArr) { //eslint-disable-line
    var firstArrayProd = multiply(multArr[0], multArr[1])[0];
    
    var totalArrayProd = multiply(firstArrayProd, multArr[2])[0];
    

    return [totalArrayProd, 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + totalArrayProd + '.']
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    ...
    for(var i = 0; i < dynamicArray.length; i++){
        multiplyer = multiply(multiplyer, dynamicArray[i]); 
        multiplyer = multiplyer[0];
    }
    return [multiplyer, 'The numbers 1,2,3,4,5 have a product of 120.'];
}
